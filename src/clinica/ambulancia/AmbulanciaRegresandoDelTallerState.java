...
public class AmbulanciaRegresandoDelTallerState implements AmbulanciaState{
	...
	public void trasladoAClinica() {
		System.out.println("AMBULANCIA OCUPADA: La ambulancia está regresando del taller");
	}

...
public class SingletonClinica 
{
	...
	/**Lista de consultas filtradas por paciente y otra por m�dicos para m�s f�cil acceso**/
	...
	/**
     * Registra un m�dico en la cl�nica.
     * <b>pre: </b>la lista de m�dicos est� inicializada y m != null<br>
     * <b>post:</b> se registr� un m�dico con los datos almacenados en el IM�dico prove�do<br>
	...
	/**
	 * Registra un paciente en la cl�nica.
	 * <b>pre: </b>la lista de pacientes est� inicializada y p != null<br>
	 * <b>post:</b> se registr� un paciente con los datos almacenados en el Paciente prove�do<br>
	...
	/**
	 * A�ade un paciente a la lista de espera
	 * <b>pre: </b>la lista de espera est� inicializada y el paciente registrado<br>
	 ...
	 * <b>pre: </b>la lista de espera est� inicializada y el paciente est� en ella<br>
	 ...
	 * <b>pre:</b> la lista est� inicializada y el paciente existe<br>
	 ...
	 * <b>pre:</b> el paciente existe y est� en el patio <br>
	...
	/**
	 * A�ade un paciente a la lista de los que est�n siendo atendidos
	 * <b>pre:</b> la lista de atenci�n est� inicializada, el paciente existe y no est� siendo atendido <br>
	...
	/**
	 * Remueve un paciente de la lista de los que est�n siendo atendidos
	 * <b>pre: la lista est� inicializada, el paciente existe y est� en la lista</b><br>
	 ...
	 * inicial en la sala de espera o en el patio, seg�n la disponibilidad y prioridad.
	 * </p>
	 *
	 * <p>
	 * Si la sala de espera est� vac�a, el paciente la ocupa. Si ya hay un paciente en
	 ...
	 *   <li>Si el nuevo paciente tiene menor prioridad, se lo env�a directamente al patio.</li>
	 * </ul><br>
	 *<b>pre:</b> la lista de espera est� inicializada, al igual que la sala de espera y el patio<br>
	 * <b>post: </b>el paciente est� en la sala de espera o el patio seg�n corresponda (y otro paciente en la sala/patio si el nuevo tom� prioridad)<br>
	 * @param p el {@link Paciente} que ingresa a la cl�nica
	 * @throws PacienteNotFoundException si el paciente no est� registrado en el sistema
	 */
	public void ingresaPaciente(Paciente p) throws PacienteNotFoundException 
	{
		...
		assert salaEspera.getPaciente().equals(p) || patio.contains(p) : "El paciente no está en su lugar de espera correspondiente";
	}
	/**<b>pre: </b><br>
	 * <b>post:</b><br>
	 * Atiende a un paciente de la cl�nica.
	 * <p>
	 * Si est� en la lista de espera lo remueve y se fija si est� en el patio o en la sala de espera.
	 * </p>
	 *<ul>
	 *   <li>Si est� en el patio lo remueve de ah�.</li>
	 *   <li>Si est� en la sala de espera lo saca de ah� y mueve a un paciente del patio a la sala.</li>
	 *</ul><br>
	 *<b>pre: </b>lista de espera, patio y sala de espera inicializados, el m�dico est� registrado, consultarPorMedico y consultarPorPaciente inicializadas<br>
	 * <b>post:</b> El paciente est� en la lista de atenci�n, lo remueve de la sala o del patio y las listas de consultas registraron ambas registraron su consulta<br>
	 *@param m El m�dico que atender� al paciente
	 *@param p El paciente a atender.
	 *
	 *@throws PacienteNotFoundException si el paciente no est� registrado en el sistema indicando  que el paciente no est� registrado
	 * */
	...
	/**
	 * Gestiona el egreso de un paciente de la cl�nica y genera la factura correspondiente.
	 * <p>
	 * Este m�todo obtiene la habitaci�n (si el paciente estuvo internado) y todas las consultas
	 * realizadas durante su estad�a, crea una factura con esa informaci�n, y remueve al paciente de todas las listas
	 * salvo la de pacientes.
	 * </p>
	 *
	 * <p>
	 * Al finalizar, el paciente es removido de las listas de atenci�n e internaci�n,
	 * y su fecha de ingreso se restablece a null para permitir futuros ingresos.
	 * </p>
	 *<b>pre: </b>la lista de internados est� inicializada al igual que la lista de pacientes en atención<br>
	 * <b>post:</b> el paciente ya no est� en la lista de internados ni en la de atenci�n, su consulta no est� m�s en la lista y la fecha de ingreso es nula<br>
	...
	public Factura egresaPaciente(Paciente p) 
	{
		...
		assert !listaEnAtencion.contains(p) : "El paciente no fue eliminado de la \"en atención\" de internados correctamente";
	...
	/**+
	 * Crea a un m�dico con sus datos esenciales incluyendo posgrado y contrataci�n
	 * <b>pre: </b>la f�brica de m�dicos est� inicializada<br>
	 * <b>post: </b>el m�dico fu� creado con la contrataci�n y el posgrado correspondientes<br>
	 * @param dni 
	...
	/**+
	 * Crea a un m�dico con sus datos esenciales sin incluir posgrado
	 * <b>pre: </b>la f�brica de m�dicos est� inicializada<br>
	...
	/**+
	 * Crea a un m�dico con sus datos esenciales sin incluir posgrado ni contratacion
	 * <b>pre: </b>la f�brica de m�dicos est� inicializada<br>
	...
	/**
	 * Crea un paciente con dni, n�mero de historia cl�nica, nombre y apellido, rango etario, tel�fono, domicilio, ciudad
	 *<b>pre: </b>la f�brica de pacientes est� inicializada<br>
	 ...
	 *<b>pre:</b> la f�brica de habitaciones est� inicializada<br>
	...
	/**
	 * Retorna un reporte de consultas del m�dico por d�a enumerando los pacientes en el per�odo de tiempo indicado
	 * <p>Muestra de forma cronol�gica las consultas con el nombre del paciente</p>
	 *<b>pre: </b>la lista consultarPorMedico fu� inicializada<br>
	 *<b>post: </b>se gener� un reporte en base a la lista de consultas correspondiente<br>

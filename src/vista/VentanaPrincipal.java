...
public class VentanaPrincipal extends JFrame {
	...
	public VentanaPrincipal() {
		...
		JButton btnNewButton_1 = new JButton(" + Agregar Asociado");
		toolBar.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton(" + Agregar Paciente");
		...
		JButton boton_navegacionInicio = new JButton("Inicio");
		panel_Navegacion.add(boton_navegacionInicio);
		
		JButton boton_navegacionAsociados = new JButton("Asociados");
		panel_Navegacion.add(boton_navegacionAsociados);
		
		JButton boton_navegacionPacientes = new JButton("Pacientes");
		panel_Navegacion.add(boton_navegacionPacientes);
		
		JButton boton_navegacionAtencion = new JButton("Atencion");

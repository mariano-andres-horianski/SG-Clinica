...
/**
 * Listener para el boton de "guardar" en el formulario de actualizacion de socio
 */
public class UpdateFormListener extends MouseAdapter{
	private ActionListener controlador;

    public UpdateFormListener(ActionListener controlador) {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (SwingUtilities.isLeftMouseButton(e)) {
            ...
            ActionEvent evento = new java.awt.event.ActionEvent(asociado, 0, "UPDATE");
